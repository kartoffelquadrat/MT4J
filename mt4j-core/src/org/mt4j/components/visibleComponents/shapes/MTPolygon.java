...
//		/*
		...
		if (!this.isNoFill()){ 
			...
			if (this.getGeometryInfo().isIndexed()){
				gl.glDrawElements(this.getFillDrawMode(), indexBuff.limit(), GL2.GL_UNSIGNED_SHORT, indexBuff);
...
//			*/
			...
			if (this.getGeometryInfo().isIndexed()){
				gl.glDrawElements(GL2.GL_LINE_STRIP, indexBuff.limit(), GL2.GL_UNSIGNED_SHORT, indexBuff);
